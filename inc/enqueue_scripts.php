...
function custom_load_scripts() {
    ...
    wp_enqueue_style('style-name', get_stylesheet_uri(), null, '1.2.0');
    wp_enqueue_script('script-name', get_template_directory_uri().'/js/dist/main.min.js', array('jquery'), '1.2.0', true);
}
